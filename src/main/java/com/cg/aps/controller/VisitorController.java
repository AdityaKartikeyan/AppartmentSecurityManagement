...
public class VisitorController {
	...
	@ApiOperation(value="Add Visitor Salary", response = VisitorEntity.class, tags = "add-Visitor",	httpMethod = "POST")
	...
	@ApiOperation(value="Update Visitor Salary",response = VisitorEntity.class,tags = "update-Visitor",httpMethod = "PUT")
	...
	@ApiOperation(value="Delete Visitor Salary",response = String.class,tags = "delete-Visitor",httpMethod = "DELETE")
